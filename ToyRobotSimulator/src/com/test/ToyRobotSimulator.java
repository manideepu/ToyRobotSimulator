...
public class ToyRobotSimulator {
  ...
  static {
    ...
    try {
      commands.put("MOVE", ToyRobotSimulator.class.getDeclaredMethod("move"));
      commands.put("LEFT", ToyRobotSimulator.class.getDeclaredMethod("left"));
      commands.put("RIGHT", ToyRobotSimulator.class.getDeclaredMethod("right"));
      commands.put("REPORT", ToyRobotSimulator.class.getDeclaredMethod("report"));
...
class Robot {
  ...
  public boolean isOutOfRange() {
    if (this.point.x > TableTop.MAX_WIDTH || this.point.x < 0 || this.point.y > TableTop.MAX_HEIGHT || this.point.y < 0) {
      return true;
    }
